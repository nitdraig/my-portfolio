...
export type ContentItem =
  ...
  | { date: string; role: string; company: string };
...
export type NodeContent =
  ...
  | { type: "timeline"; title: string; items: { date: string; role: string; company: string }[] };
...
export const NODE_DATA: Record<NodeKey, NodeData> = {
  AI: {
    ...
    content: {
      ...
      title: "How I use AI",
      items: [
        { title: "Discipline over speed", text: "La IA no es un mago al que le pedís un deseo, es un colaborador técnico al que hay que darle contexto, roles, restricciones y criterios de revisión." },
        { title: "Lexis ecosystem", text: "Ecosistema propio de agentes especializados que no premia la velocidad ciega sino el criterio. Cada agente tiene un rol definido y boundaries claros." },
        ...
        { title: "The ladder", text: "¿Esto necesita existir? ¿Ya lo resuelve el lenguaje? ¿Ya lo resuelve algo instalado? ¿Puede ser una sola línea? Solo si nada alcanza, se construye código nuevo." },
      ],
    },
    detail: {
      ...
      sections: [
        { title: "Anti-prompt-theater", text: "La IA no es un mago al que le pedís un deseo, es un colaborador técnico al que hay que darle contexto, roles, restricciones y criterios de revisión, igual que a cualquier persona del equipo. Antes de que un agente escriba una sola línea, tiene que pasar por una escalera de decisión." },
        { title: "The ladder", text: "¿Esto necesita existir? (YAGNI). ¿Stdlib lo hace? ¿La plataforma lo resuelve? ¿Ya hay algo instalado? ¿Puede ser una sola línea? Solo si nada de eso alcanza, se construye código nuevo — el mínimo que funciona bajo condiciones reales." },
      ...
      links: [
        { label: "Context Engineering ebook", url: "#" },
        { label: "Lexis ecosystem", url: "#" },
      ],
    },
  },
  CODE: {
    ...
    detail: {
      ...
      sections: [
        ...
        { title: "How I code", text: "Reviso mis propios cambios buscando sobre-ingeniería antes de que alguien más tenga que hacerlo. Y cuando tomo un atajo consciente, lo dejo marcado en el código para volver después — no escondido, documentado." },
      ],
      links: [
  ...
  PROJECTS: {
    ...
    detail: {
      ...
      sections: [
        { title: "Common patterns", text: "Onboarding en 3 pasos, dashboards con métricas accionables, flujos de pago integrados, sistemas de notificación por eventos, y MVPs que shippean en 2-4 semanas." },
        { title: "Industries", text: "Healthcare, fintech, education, sustainability, developer tools, management. La industria define las constraints; el patrón de producto se reutiliza." },
        { title: "How I work", text: "Descubrimiento → validación → MVP → iteración. Cada fase tiene un entregable tangible. No sigo adelante sin validar la hipótesis clave." },
      ],
    },
  },
  MVP: {
    ...
    content: {
      ...
      title: "Why MVP first",
      items: [
        { title: "Reduce risk", text: "Validás la hipótesis clave antes de invertir meses en features no prioritarias." },
        { title: "Speed to learn", text: "En 2-4 semanas tenés usuarios reales dando feedback sobre algo tangible." },
        { title: "Focus", text: "Obliga a definir el loop de valor central y descartar lo demás." },
        { title: "Discipline", text: "Discovery → validación → MVP → iteración. Cada fase tiene un entregable tangible. No sigo adelante sin validar la hipótesis clave." },
      ],
    },
    detail: {
      ...
      sections: [
        { title: "The process", text: "Week 1: Discovery + hipótesis. Week 2-3: Build el loop central. Week 4: Release a early users + instrumentar. Week 5+: Iterar con datos reales. Cada fase tiene un entregable tangible." },
        { title: "What stays out", text: "Perfiles de usuario elaborados, dashboards admin, settings avanzados, integración con 3ros, y todo lo que no contribuye a validar la hipótesis central." },
        { title: "Success metric", text: "No es features shipped; es aprendizaje por semana. Si después de 4 semanas no sabés más que al inicio, el MVP falló. Un MVP no es un producto roto; es la versión mínima que permite aprender algo real." },
      ],
    },
  },
  RESOURCES: {
  ...
  CLIENTS: {
    ...
    detail: {
      ...
      sections: [
        { title: "How I collaborate", text: "Trabajo directo con founders y product leads. No necesito un PM intermedio; hablo el lenguaje del negocio y del código. Reuniones cortas, entregables claros, iteración constante." },
        { title: "Engagement model", text: "De discovery a deploy: scope acotado, milestone-based, comunicación semanal con demos funcionales. Sin sorpresas, sin scope creep." },
        { title: "After launch", text: "Soporte post-launch incluido en el alcance. No desaparezco después del deploy. Si algo rompe, lo arreglo. Si hay learnings, los documentamos." },
      ],
    },
  },
  ABOUT: {
    ...
    chips: ["Experience", "Background", "Contact"],
    content: {
      type: "timeline",
      title: "Experience",
      items: [
        { date: "2025 — Present", role: "Front-end Developer SSR", company: "Around Notes" },
        { date: "2025 — Present", role: "Founder, Developer & PM", company: "Excelso" },
        { date: "2026", role: "CTO & Co-founder", company: "Experimental Global" },
        { date: "2024 — 2025", role: "Web Dev Project Manager", company: "IcarisTech" },
        { date: "2024", role: "Project Manager", company: "DigiChanges" },
        { date: "2024", role: "Product Owner & IT PM", company: "InkuA" },
        { date: "2023 — 2024", role: "Founder, PM & Fullstack Dev", company: "Fuddy" },
        { date: "2018 — 2023", role: "Multimedia Editor & Dev", company: "Tinta Negra Studios" },
        { date: "2023", role: "Front-End Developer", company: "Advance Valley" },
      ],
    },
    detail: {
      ...
      sections: [
        { title: "What drives me", text: "Resolver problemas reales con herramientas simples. No me interesa la tecnología por la tecnología; me interesa qué cambia en la vida de alguien cuando el producto funciona. Soy PM porque necesito ordenar. Soy developer porque necesito poder ejecutar lo que ordeno." },
        { title: "How I work", text: "Discovery antes de especificación, especificación antes de implementación, revisión antes de cerrar. Trabajo directo con founders y product leads, sin PM intermedio. Reuniones cortas, entregables claros, iteración constante." },
        { title: "What I'm looking for", text: "Problemas interesantes, equipos que valoran la claridad, y productos donde la calidad técnica importa porque el producto importa. Si buscás a alguien que ordene el problema, construya con criterio y te acompañe con la cabeza puesta en el resultado, hablemos." },
      ],
      links: [
        { label: "me@agustin.top", url: "mailto:me@agustin.top" },
  ...
  REASONING: {
    ...
    content: {
      ...
      title: "How I think",
      items: [
        { title: "First principles", text: "Desarmo el problema hasta sus partes irreducibles antes de elegir solución." },
        { title: "Boring over clever", text: "Prefiero un one-liner aburrido a una abstracción elegante que nadie pidió. Reviso mis propios cambios buscando sobre-ingeniería." },
        { title: "Measure first", text: "No optimizo por intuición. Agrego instrumentación antes de cambiar cualquier sistema." },
        { title: "Ship to learn", text: "El feedback real vale más que cualquier debate de arquitectura en una sala." },
      ],
    },
    detail: {
      ...
      sections: [
        ...
        { title: "Decisions", text: "Cada decisión técnica tiene un costo: complejidad, tiempo, deuda. Elijo la opción que maximiza aprendizaje por esfuerzo. Si no sé cuál es, mido antes de decidir. Y cuando tomo un atajo consciente, lo dejo marcado en el código para volver después." },
        { title: "Iteration", text: "No planifico 6 meses adelante. Planifico 2 semanas, shippeo, aprendo, y replanifico. La iteración corta es mi herramienta de gestión principal. Los retrabajos justos, sorpresas acordes, plazos que se cumplen." },
      ],
    },
  },
  ENVIRONMENT: {
    ...
    content: {
      type: "list",
      title: "Environmental lens",
      items: [
        { title: "Field background", text: "Trabajo de campo en el Salar del Hombre Muerto. Ese cambio de mirada — ver relaciones entre piezas, no piezas aisladas — nunca lo abandoné." },
        { title: "Systems thinking", text: "Abordo los problemas como sistemas interconectados, no como síntomas aislados. Esto aplica a ecosistemas, proyectos de software y equipos." },
    ...
    detail: {
      ...
      sections: [
        ...
        { title: "Systems approach", text: "Aplico pensamiento sistémico a productos digitales: no optimizo un componente sin entender su impacto en el sistema completo. Esto evita soluciones que rompen otra parte. Solo cambié el terreno." },
        { title: "Research", text: "Investigación académica sobre IA aplicada a auditoría ambiental. La IA acelera y detecta, pero el juicio final — técnico, ético, humano — no se delega. Eso no es una limitación de la tecnología. Es una decisión de diseño." },
      ],
      links: [{ label: "JEMA project", url: "#" }],
    },
  },
  AIDEV: {
    tag: "AGENTS",
    ...
    detail: {
      ...
      sections: [
        ...
        { title: "What I build", text: "Agentes de código que implementan features, agentes de análisis que procesan datos, agentes de soporte que responden con contexto, y pipelines de automatización que conectan servicios." },
        { title: "Approach", text: "Empiezo con el flujo manual más simple, lo automatizo, y solo después agrego complejidad. Un agente que falla el 5% de las veces es peor que un humano que falla el 5%." },
      ],
      links: [{ label: "Excelso Open", url: "https://www.excelso.xyz" }],
    },
  },
};
